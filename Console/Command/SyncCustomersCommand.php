...
{
    public const NAME = 'omnipro:sync:customers';

    /**
     * Construct
     *
     * @param SynchronizeCustomer $synchronizeCustomer
     * @param State $state
     * @param string|null $name
     */
    public function __construct(
        protected SynchronizeCustomer $synchronizeCustomer,
    ...
    protected function execute(
        ...
        $status = $this->synchronizeCustomer->process();
        Console::printTable(
            $status->getHeaders(),
            $status->getRows(),
            $output
